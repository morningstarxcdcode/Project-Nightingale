...
class TestConfig:
    ...
    def test_config_merge_behavior(self) -> None:
        ...
        # Create base config
        base_config = {
            "app": {"name": "Base App", "version": "1.0.0", "debug": False},
            "database": {"file": "base.db"},
        }

        # Create override config
        override_config = {
            "app": {"name": "Override App", "debug": True, "new_key": "new_value"},
    ...
    def test_config_invalid_app_name_types(
        self, invalid_data: any, expected_error: str
    ) -> None:
