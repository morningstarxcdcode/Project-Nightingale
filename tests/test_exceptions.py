...
class TestCustomExceptions:
    ...
    def test_multiple_exception_scenarios(self) -> None:
        ...
        try:
            ...
            try:
                model_error = ModelProcessingError("Cannot process due to validation error")
    ...
    @pytest.mark.parametrize("exception_class,message,extra_arg", [
    ...
    def test_exception_creation_parametrized(self, exception_class: type, message: str, extra_arg: any) -> None:
