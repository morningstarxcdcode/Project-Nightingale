...
class TestAI:
    ...
    def test_model_invalid_inputs_parametrized(self, input_data: any, expected_error: str) -> None:
    ...
    def test_model_thread_safety(self) -> None:
        ...
        for i, result in enumerate(results):
            assert f"test input {i}" in result or any(f"test input {j}" in result for j in range(10))
