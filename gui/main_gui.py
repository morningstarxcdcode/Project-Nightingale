...
from scripts.exceptions import NightingaleError, DataValidationError
...
class Application(tk.Tk):
    ...
    def _create_header(self, parent: tk.Widget) -> None:
        ...
        desc_label = ttk.Label(
            header_frame,
            text="A health monitoring and prediction system using AI and machine learning",
            font=("Helvetica", 12),
            foreground="#666666"
        )
    ...
    def _create_input_section(self, parent: tk.Widget) -> None:
        ...
        input_label = ttk.Label(
            input_frame,
            text="Enter health data for AI analysis (e.g., 'heart rate: 72 bpm, temperature: 98.6°F'):"
        )
    ...
    def _create_results_section(self, parent: tk.Widget) -> None:
        ...
        self.result_text.tag_configure("success", foreground="green", font=("Consolas", 10, "bold"))
        self.result_text.tag_configure("error", foreground="red", font=("Consolas", 10, "bold"))
        self.result_text.tag_configure("info", foreground="blue", font=("Consolas", 10, "italic"))
    ...
    def process_input(self) -> None:
        ...
        if not input_data:
            messagebox.showwarning("Input Error", "Please enter some health data to analyze.")
